...
public class CommonFollowersMapperUsingList
    ...
    public void map(LongWritable key, Text value, Context context)
        ...
        ArrayListOfLongsWritable friends = getFollowers(tokens);
